...
const FormAddBuletin = () => {
  ...
  const saveFacility = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://api.bimbel-sinteta.id/api/v1/bulletin/add-bulletin", formData, config);
