...
const FormAddCongratulations = () => {
  ...
  const saveKelas = async (e) => {
    ...
    try {
      ...
      const response = await axios.post("https://api.bimbel-sinteta.id/api/v1/congratulation/add-congratulation", formData, config);
...
export default FormAddCongratulations