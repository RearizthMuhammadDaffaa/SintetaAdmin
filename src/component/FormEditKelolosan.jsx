...
const FormEditKelolosan = () => {
  ...
  const updatekelas = async (e) => {
    ...
    try {
      ...
      const response = await axios.put(`https://api.bimbel-sinteta.id/api/v1/acceptedUniversity/update-acceptedUniversity/${id}`, formData, config);
...
export default FormEditKelolosan